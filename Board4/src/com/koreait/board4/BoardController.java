...
public class BoardController {
	...
	public void detail(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//ip 주소로 구분하여 application 객체 이용해서 새로고침 시 조회수가 안 올라가도록 조치.
		
		//1. 아이피 주소값 얻어야함
		//2. application에서 "특정 키 값 만들어야 함" 즉, 어떤 글인지 구분이 가능해야한다.
		//3. application에서 특정 키 값으로 값이 있는지 체크
		//3-1 : 없으면 그 특정 키 값으로 나의 ip주소를 set 한다. (조회수 올리는 것)
		//3-2 : 있으면 application에 저장된 ip주소가 나랑 같은지 확인
		//3-2-1 : 같으면 무시
		//3-2-2 : 다르면 (조회수 올림) -> 그 특정 키 값으로 나의 ip 주소를 set 한다.
